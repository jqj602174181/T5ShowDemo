...
public class BlueToothClsUtils {
    ...
    { 
        ...
        Log.d("returnValue", "createBond：" + returnValue.booleanValue());
    ...
    { 
        ...
        Log.d("returnValue", "removeBond：" + returnValue.booleanValue());
        return returnValue.booleanValue(); 
    } 
    ...
    { 
        ...
        { 
            ...
            Boolean returnValue = (Boolean) setPasskeyMethod.invoke(btDevice, key); 
            Log.d("returnValue", "setPasskey is success " +btDevice.getAddress()+ returnValue.booleanValue());
        } 
        catch (SecurityException e) 
        { 
            // throw new RuntimeException(e.getMessage()); 
    ...
    @SuppressWarnings("unchecked")
	static public boolean setPairingConfirmation(Class btClass, BluetoothDevice btDevice)throws Exception {
    	 Method SetPairingConfirmationMethod = btClass.getMethod("setPairingConfirmation", 
    	 boolean.class);
    	 Boolean returnValue = false;
    	 returnValue =(Boolean)SetPairingConfirmationMethod.invoke(btDevice, true);
    	 Log.d("returnValue", "setPairingConfirmation is success ");
    	 return returnValue;
    	}
