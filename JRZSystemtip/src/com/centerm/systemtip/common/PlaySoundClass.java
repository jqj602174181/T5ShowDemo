...
public class PlaySoundClass
{
	...
	private int audioStyle = AudioManager.STREAM_ALARM;
	public PlaySoundClass(Context context)
	{
	//	mContext = MainActivity.getProcessContext().getApplicationContext();
	...
	// 播放语音
	public MediaPlayer playAudio(String filename)
	{
	...
	public void playKeyBeep()
	{
		...
		int maxVol = audioManager.getStreamMaxVolume(audioStyle);
		int currentVol = audioManager.getStreamVolume(audioStyle);
	...
	{
		sndPool = new SoundPool(10, audioStyle, 0);
